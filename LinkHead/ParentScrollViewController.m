...
#import "ParentScrollViewController.h"

@interface ParentScrollViewController ()<UIGestureRecognizerDelegate>

@end

@implementation ParentScrollViewController
...
-(BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer
{
    ...
    if ([otherGestureRecognizer.view isKindOfClass:NSClassFromString(@"UITableViewCellContentView")]) {
